...
if __name__ == '__main__':
    ...
    BASE_CHECKPOINT = 'best_efficientnet_b0.pth'
    TUNED_CHECKPOINT = 'best_efficientnet_b0_tuned.pth'
    ...
    optimizer_base = optim.Adam(model.classifier.parameters(), lr=BASE_LR)
